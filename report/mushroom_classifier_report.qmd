...
![The Distribution of Feature Cap Diameter](../results/figures/histogram_cap-diameter.png){#fig-cap-diameter width=50%}

![The Distribution of Feature Stem Height](../results/figures/histogram_stem-height.png){#fig-stem-height width=50%}

![The Distribution of Feature Stem Width](../results/figures/histogram_stem-width.png){#fig-stem-width width=50%}
...
![The Distribution of Feature Cap Shape](../results/tables/cap-shape_frequency_table.png){#fig-cap-shape}

![The Distribution of Feature Cap Color](../results/tables/cap-color_frequency_table.png){#fig-cap-color}

![The Distribution of Feature Bruise or Bleed](../results/tables/does-bruise-or-bleed_frequency_table.png){#fig-does-bruise-or-bleed}

![The Distribution of Feature Gill Color](../results/tables/gill-color_frequency_table.png){#fig-gill-color}

![The Distribution of Feature Stem Color](../results/tables/stem-color_frequency_table.png){#fig-stem-color}

![The Distribution of Feature Stem Color](../results/tables/has-ring_frequency_table.png){#fig-has-ring}

![The Distribution of Feature Stem Color](../results/tables/ring-type_frequency_table.png){#fig-ring-type}

![The Distribution of Feature Stem Color](../results/tables/habitat_frequency_table.png){#fig-habitat}

![The Distribution of Feature Stem Color](../results/tables/season_frequency_table.png){#fig-season}
...
![The Distribution of Feature Stem Color](../results/figures/target_variable_distribution.png){#fig-target}
...
![The Distribution of Feature Stem Color](../results/figures/test_confusion_matrix.png){#fig-test_confusion_matrix}
